        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-6 mb-8">
            ...
            <ul className="text-base text-gray-800 space-y-3">
              <li className="flex items-center"><span className="text-orange-500 mr-2">✔</span> Budget-Friendly</li>
              <li className="flex items-center"><span className="text-orange-500 mr-2">✔</span> Luxurious Getaways</li>
          ...
          <Button className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-medium text-lg flex items-center group">
            Learn More <ArrowRightCircle className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
          </Button>
        </div>
      </section>
